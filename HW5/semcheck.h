...
void verifyArithmeticOp( struct expr_sem *op1, OPERATOR operator1, struct expr_sem *op2 ); 
void verifyRelOp( struct expr_sem *op1, OPERATOR operator1, struct expr_sem *op2 , struct SymTable *table, int scope, char *fileName, int count);
void verifyUnaryNOT( struct expr_sem *expr, struct SymTable *table, int scope, char *fileName );
void verifyAndOrOp( struct expr_sem *op1, OPERATOR operator1, struct expr_sem *op2, struct SymTable *table, int scope, char *fileName );
